...
import pl.touk.nussknacker.ui.security.api.{AuthenticatedUser, DefaultAuthenticationConfiguration, LoggedUser, RulesSet}
...
class BasicHttpAuthenticator(configuration: DefaultAuthenticationConfiguration) extends SecurityDirectives.AsyncAuthenticator[AuthenticatedUser] {
