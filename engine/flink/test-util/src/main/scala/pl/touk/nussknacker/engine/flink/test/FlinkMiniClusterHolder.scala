...
/**
  * This interface provides api to manage flink cluster. It also provides compatibility for another Flink's version.
  * Instance of mini cluster holder should be create only once for many jobs.
  */
