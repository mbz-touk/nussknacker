...
/**
  ...
  */
trait FlinkGenericContextInitializer[Raw, DefinedParameter <: BaseDefinedParameter, State] { self: FlinkContextInitializer[Raw] =>
  ...
  /**
    ...
    */
  def validationContext(context: ValidationContext, dependencies: List[NodeDependencyValue], parameters: List[(String, DefinedParameter)], state: Option[State])(implicit nodeId: NodeId): ValidationContext
