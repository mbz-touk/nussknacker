      ...
      get {
        complete {
          ...
          val authenticationSettings = AuthenticationSettings(
            ...
            authenticationConfig.publicKey,
            authenticationConfig.validateNonce
          )
...
@JsonCodec case class AuthenticationSettings(backend: String, authorizeUrl: Option[String], publicKey: Option[String], validateNonce: Boolean)
